...
function initializeApp() {
    ...
    async function fetchPredictionsAPI() {
        try {
            ...
            console.warn('Using local predictions fallback:', err.message);
        }
    }
...
function renderPredictions() {
    ...
    container.innerHTML = predictions.map((movie, index) => `
        <div class="prediction-card">
            ...
            <div class="prediction-analysis">
                <div class="prediction-result ${movie.prediction.hit ? 'hit' : 'flop'}">
                    <i class="fas ${movie.prediction.hit ? 'fa-thumbs-up' : 'fa-thumbs-down'}"></i>
                    <span>${movie.prediction.hit ? 'HIT' : 'FLOP'}</span>
                </div>
                <div class="prediction-confidence">
                    <span>Confidence: ${movie.prediction.confidence}%</span>
                </div>
            </div>
            <div class="prediction-financials">
                <div class="financial-item">
                    <span class="financial-label">Predicted Collections</span>
                    <span class="financial-value">$${movie.prediction.collections}M</span>
                </div>
                <div class="financial-item">
                    <span class="financial-label">ROI</span>
                    <span class="financial-value">${movie.prediction.roi}%</span>
                </div>
            </div>
            <div class="prediction-buzz">
                <div class="buzz-metric">
                    <i class="fab fa-instagram"></i>
                    <span>${movie.buzz.instagramPosts}</span>
                </div>
                <div class="buzz-metric">
                    <i class="fab fa-youtube"></i>
                    <span>${movie.buzz.youtubeViews}</span>
                </div>
                <div class="buzz-metric">
